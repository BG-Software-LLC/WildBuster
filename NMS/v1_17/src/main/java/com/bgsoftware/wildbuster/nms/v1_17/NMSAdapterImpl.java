...
public class NMSAdapterImpl extends com.bgsoftware.wildbuster.nms.v1_17.AbstractNMSAdapter {
    ...
    protected LevelChunkSection getChunkSectionForY(LevelChunk levelChunk, int y) {
        ...
        if (chunkSection == null) {
            ...
            chunkSection = chunkSections[index] = new LevelChunkSection(yOffset);
        }
